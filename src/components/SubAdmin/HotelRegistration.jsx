        ...
        if (res.data.response[0].length !== 0) {
         res.data.response[0].map((item)=>{
           this.setState({
            ...
            serviceCharge : item.serviceCharges,
            currency : item.currencyFormat,
            logo : item.logo,
            image : item.image,
           })
         }) 
    ...
    return (
      <Box>
        ...
        <Grid container spacing={3}>
          <Grid item xs={6} sm={4} className="mucssguid">
            <Paper>
              <TextField
                className="w-100"
                id="outlined-basic"
          ...
          <Grid item xs={6} sm={4} className="img_upload">
            <Paper>
